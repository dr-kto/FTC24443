package org.firstinspires.ftc.teamcode.queue.hardware;

import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.CLOSE_CLAW;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.IDLE;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.LOWER_ROBOT;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.RAISE_ARM_AND_LIFT;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.RAISE_ROBOT;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.RAISE_WRIST;
import static org.firstinspires.ftc.teamcode.queue.hardware.Hang.State.WAIT_FOR_USER;
import static org.firstinspires.ftc.teamcode.queue.TeleOpQueue.HANG_POSITION;

import static queue.dicelibrary.RobotRoutes.MAXIMUM_POSITION;
...
import org.firstinspires.ftc.teamcode.queue.RobotHardwareQueue;

@Config
public class Hang {
    public enum State {IDLE, CLOSE_CLAW, RAISE_WRIST, RAISE_ARM_AND_LIFT, RAISE_ROBOT, WAIT_FOR_USER, LOWER_ROBOT}

    public static int LOWER_ROBOT_SPEED = 50;

    private RobotHardwareQueue robotHardware;
    private Hang.State state = IDLE;
    private ElapsedTime timer = new ElapsedTime();

    public Hang(RobotHardwareQueue robotHardware) {
    ...
    // Sets the state.
    private void setState(Hang.State state) {

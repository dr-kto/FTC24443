...
import org.firstinspires.ftc.teamcode.AutoF;
import org.firstinspires.ftc.teamcode.AutoG;
import org.firstinspires.ftc.teamcode.Claw;
import org.firstinspires.ftc.teamcode.HeatSeekC;
import org.firstinspires.ftc.teamcode.queue.hardware.Lift;
import org.firstinspires.ftc.teamcode.queue.Place;
import org.firstinspires.ftc.teamcode.Retract;
...
import org.firstinspires.ftc.teamcode.queue.hardware.Hang;

@Config
public class RobotHardwareQueue {
...
//    private Retract retract = new Retract(this);
    ...
    // Initializes this.
    public RobotHardwareQueue(LinearOpMode opMode) throws InterruptedException {
...
//                "Heat Seek = %s, " +
//                        "Retract = %s, " +
                        "Hang = %s, Place = %s, Turtle Mode = %b, Robot Pose = %s, Back Left = %.0f mm, Back Right = %.0f mm",
//                heatSeek.getState(),
//                retract.getState(),
                hang.getState(), place.getState(), isTurtleMode, poseString, leftBackMillimeters, rightBackMillimeters);
